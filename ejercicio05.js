...
let totalRockDuration = 0 // Inicializamos la variable para acumular la duración

// Recorremos todos los álbumes
for (let i = 0; i < albums.length; i++) {
  if (albums[i].genre === 'Rock') {
    // Verificamos si el género es Rock
    totalRockDuration += albums[i].duration // Sumamos la duración
  }
}

// Imprimimos el total de la duración de los álbumes de rock
